...
class AirPlaneSpecification extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Id', 'required'),
			array('Id, NoOfFirstClassSeats, NoOfBusinessClassSeats, NoOfEconomyClassSeats, PriceOfFirstClassSeats, PriceOfBusinessClassSeats, PriceOfEconomyClassSeats', 'numerical', 'integerOnly'=>true),
			array('Name, Type', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('Id, Name, Type, NoOfFirstClassSeats, NoOfBusinessClassSeats, NoOfEconomyClassSeats, PriceOfFirstClassSeats, PriceOfBusinessClassSeats, PriceOfEconomyClassSeats', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'airplanes' => array(self::HAS_MANY, 'Airplane', 'specificationId'),
		);
	}
