...
class SeatController extends RController
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Seat']))
        {
            ...
            if ($model->save())
            {
                $message = 'TA LOG: New Seat created by user = ' . Yii::app()->user->id;
                Yii::log($message, 'info', 'application.controllers.SeatController');
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['Seat']))
        {
            ...
            if ($model->save())
            {
                $message = 'TA LOG: Seat ' . $id . ' edited by user = ' . Yii::app()->user->id;
                Yii::log($message, 'info', 'application.controllers.SeatController');
    ...
    public function actionDelete($id)
    {
        if (Yii::app()->request->isPostRequest)
        {
            ...
            $message = 'TA LOG: Seat ' . $id . ' deleted by user = ' . Yii::app()->user->id;
            Yii::log($message, 'info', 'application.controllers.SeatController');
