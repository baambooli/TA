...
class CityController extends RController
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['City']))
        {
            ...
            if ($model->save())
            {
                $message = 'TA LOG: New City created by user = ' . Yii::app()->user->id;
                Yii::log($message, 'info', 'application.controllers.CityController');
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['City']))
        {
            ...
            if ($model->save())
            {
                $message = 'TA LOG: City ' . $id . ' edited by user = ' . Yii::app()->user->id;
                Yii::log($message, 'info', 'application.controllers.CityController');
    ...
    public function actionDelete($id)
    {
        if (Yii::app()->request->isPostRequest)
        {
            ...
            $message = 'TA LOG: City ' . $id . ' deleted by user = ' . Yii::app()->user->id;
            Yii::log($message, 'info', 'application.controllers.CityController');
