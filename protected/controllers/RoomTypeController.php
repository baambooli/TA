...
class RoomTypeController extends RController
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['RoomType']))
        {
            ...
            if ($model->save())
            {
                $message = 'TA LOG: New RoomType created by user = ' . Yii::app()->user->id;
                Yii::log($message, 'info', 'application.controllers.RoomTypeController');
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['RoomType']))
        {
            ...
            if ($model->save())
            {
                $message = 'TA LOG: RoomType ' . $id . ' edited by user = ' . Yii::app()->user->id;
                Yii::log($message, 'info', 'application.controllers.RoomTypeController');
    ...
    public function actionDelete($id)
    {
        if (Yii::app()->request->isPostRequest)
        {
            ...
            $message = 'TA LOG: RoomType ' . $id . ' deleted by user = ' . Yii::app()->user->id;
            Yii::log($message, 'info', 'application.controllers.RoomTypeController');
