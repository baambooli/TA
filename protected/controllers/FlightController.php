...
class FlightController extends RController
{
    ...
    {
        $dataProvider = new CActiveDataProvider('Flight');
    ...
    {
        $model = Flight::model()->findByPk($id);
        if ($model === null)
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'flight-form')
        {
