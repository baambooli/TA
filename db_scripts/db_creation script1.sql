...
-- Script date 12/17/2012 5:53:13 PM
...
CREATE TABLE flights(
  ...
  REFERENCES airplane (FlightId) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE cities(
  ...
  REFERENCES flights (DepartureId) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT FK_cities_flightes_DestinationId FOREIGN KEY (Id)
  REFERENCES flights (DestinationId) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT FK_cities_hotels_CityId FOREIGN KEY (Id)
  REFERENCES hotels (CityId) ON DELETE NO ACTION ON UPDATE NO ACTION
)
ENGINE = INNODB
AUTO_INCREMENT = 4
CHARACTER SET utf8
